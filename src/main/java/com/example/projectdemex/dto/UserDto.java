...
public class UserDto {
    ...
    @Pattern(regexp = "^[А-ЯЁ][а-я]{0,15}$|^[A-Z][a-z]{0,15}$|^$", message = "Отчество должно начинаться с заглавной буквы и содержать только буквы кириллицы или латиницы")
    @Size(min = 0, max = 20, message = "Отчество должно содержать от 0 до 20 символов")
